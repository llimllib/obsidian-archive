...
- [Bill de hÓra](https://dehora.net/journal/2026/modelwerk-neural-networks-as-machinery)

The [project](https://github.com/dehora/modelwerk) he's writing about is cool too, a journey through the implementation of different kinds of neural networks from a Perceptron to an Attention model, all using only the python standard library.

...
- `scores` is a dictionary of sets of letters, and represents the score for a set of seven letters
- **step 1** calculate the score of every set of seven letters
- let $scores$ be a hash of $set(letters): int(score)$ which defaults to 0
